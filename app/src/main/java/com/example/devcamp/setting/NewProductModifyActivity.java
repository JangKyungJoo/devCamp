...
public class NewProductModifyActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_product_modify);
        Intent i = getIntent();
        activityName = i.getStringExtra("item");
        //System.out.println(activityName);
        SharedPreferences pref = getSharedPreferences(Special.NEWPRODUCT_NAME, MODE_PRIVATE);
        ...
        saveButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Special.modifySepcial(getApplicationContext(), Special.NEWPRODUCT_NAME, activityName, editText.getText().toString(), String.valueOf(d));
                //System.out.println("edit:"+editText.getText().toString());
                Intent backadd = new Intent(NewProductModifyActivity.this, NewProductActivity.class);
        ...
        deleteButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Special.deleteSpecial(getApplicationContext(), Special.NEWPRODUCT_NAME, activityName);
                Intent backadd = new Intent(NewProductModifyActivity.this, NewProductActivity.class);
                startActivity(backadd);
                finish();
            }

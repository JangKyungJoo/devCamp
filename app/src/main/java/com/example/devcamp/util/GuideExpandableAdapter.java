...
public class GuideExpandableAdapter extends BaseExpandableListAdapter{
    ...
    public GuideExpandableAdapter(Context c, ArrayList<String> groupList,
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if(v == null){
            ...
            v = inflater.inflate(R.layout.list_guide, parent, false);
        ...
        if(isExpanded){
            viewHolder.iv_image.setImageResource(R.drawable.image1);
        }else{
            viewHolder.iv_image.setBackgroundColor(Color.WHITE);
            viewHolder.icon_image.setImageResource(R.drawable.image1);
        }
